*1 IPC (inter processor communication) feature will provide communication channel between the two processors of the system, as defined in system architecture and software architecture
